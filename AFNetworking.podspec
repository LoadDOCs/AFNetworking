Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/LoadDOCs/AFNetworking'
  s.social_media_url = 'https://twitter.com/AFNetworking'
  s.authors  = { 'Mattt Thompson' => 'm@mattt.me', 'Bobbi Diamond' => 'bobbi.diamond@withvector.com' }
  s.source   = { :git => 'https://github.com/LoadDOCs/AFNetworking.git', :tag => s.version }
